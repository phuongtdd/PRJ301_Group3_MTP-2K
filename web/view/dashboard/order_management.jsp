            ...
            <table class="order-table">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-icons">
                                    <i class="fas fa-eye" onclick="viewOrder(${order.id})"></i>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-icons">
                                <i class="fas fa-eye" onclick="viewOrder('ORD001')"></i>
                                <i class="fas fa-edit" onclick="editOrder('ORD001')"></i>
                                <i class="fas fa-trash" onclick="deleteOrder('ORD001')"></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="action-icons">
                                <i class="fas fa-eye" onclick="viewOrder('ORD002')"></i>
                                <i class="fas fa-edit" onclick="editOrder('ORD002')"></i>
                                <i class="fas fa-trash" onclick="deleteOrder('ORD002')"></i>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="action-icons">
                                <i class="fas fa-eye" onclick="viewOrder('ORD003')"></i>
                                <i class="fas fa-edit" onclick="editOrder('ORD003')"></i>
                                <i class="fas fa-trash" onclick="deleteOrder('ORD003')"></i>
                            </div>
                        </td>
                    </tr>
                </tbody>
