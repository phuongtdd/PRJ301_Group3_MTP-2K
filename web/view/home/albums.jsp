    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="album-header">
                <img src="${pageContext.request.contextPath}/${sessionScope.album.imageUrl}" alt="Album Cover" class="album-cover">
                <div class="album-info">
                    <span class="album-type">Album</span>
                    <h1 class="album-title">${sessionScope.album.title}</h1>
                    <div class="album-meta">
                        <img src="${pageContext.request.contextPath}/${sessionScope.artist.imageUrl}" alt="Artist" class="artist-avatar">
                        <a href="#" style="color: #a8b2d1; text-decoration: none; font-size: 12px;">${artist.name}</a>
                        <span>•</span>
                        <span>2021</span>
                        <span>•</span>
                        <span>5 songs</span>
