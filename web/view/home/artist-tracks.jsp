...
<head>
    ...
    <title>Artist Tracks - MTP-2K</title>
    ...
    <div class="main-content">
        ...
        <div class="all-container">
            <div class="all-header">
                <h1 class="all-title">All Tracks by ${requestScope.artist.name}</h1>
            ...
            <div class="grid-container">
                <c:choose>
                    <c:when test="${not empty requestScope.artistTracks}">
                        <c:forEach var="track" items="${requestScope.artistTracks}">
                            <div class="track-card">
                                ...
                                <div onclick="document.getElementById('trackForm${track.trackID}').submit();"
