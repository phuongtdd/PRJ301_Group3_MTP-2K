    ...
    <body>
        ...
        <div class="main-content">
            ...
            <div class="artist-header">
                ...
                <div class="artist-info">
                    ...
                    <div class="artist-stats">
                        <span class="monthly-listeners">8,282,123 monthly listeners</span>
                    </div>
                </div>
            </div>
            ...
            <div class="artist-actions">
                ...
                <i class="fas fa-ellipsis-h artist-action-icon"></i>
            </div>
                    ...
                    <div class="track-item popular">
                        ...
                        <div class="track-info">
                            ...
                            <div class="track-details">
                                ...
                                <div class="track-plays">1,234,567 plays</div>
                            </div>
                        </div>
                    ...
                    <div class="track-item popular">
                        ...
                        <div class="track-info">
                            ...
                            <div class="track-details">
                                ...
                                <div class="track-plays">987,654 plays</div>
                            </div>
                        </div>
                    ...
                    <div class="track-item popular">
                        ...
                        <div class="track-info">
                            ...
                            <div class="track-details">
                                ...
                                <div class="track-plays">876,543 plays</div>
                            </div>
                        </div>
            ...
            <section class="popular-releases">
                ...
                <div class="album-section">
                    ...
                    <div class="album-card">
                        <img src="../image/muonroimasaocon.jpg" alt="Album Cover">
                        <div class="card-info">
                            <h3 class="card-title">Muộn rồi mà sao còn</h3>
                            <p class="card-description">Single • 2022</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="popular-releases">
                ...
                <div class="album-section">
                    ...
                    <div class="album-card">
                        <img src="../image/makingmyway.jpg" alt="Album Cover">
                        <div class="card-info">
                            <h3 class="card-title">Making My Way</h3>
                            <p class="card-description">Single • 2023</p>
                        </div>
                    </div>
                    <div class="album-card">
                        <img src="../image/chungtacuahientai.jpg" alt="Album Cover">
                        <div class="card-info">
