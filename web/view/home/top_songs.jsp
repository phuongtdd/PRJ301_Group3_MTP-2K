        ...
        <body>
            ...
            <div class="main-content">
                ...
                <div class="tracks-list">
                    ...
                    <c:forEach var="item" items="${topTracks}" varStatus="loop">
                        <div class="track-item">
                            ...
                            <div class="track-info">
                                <form id="trackViewForm_${loop.index}"
                                    ...
                                    style="display:none;">
                                    <input type="hidden" name="id" value="${item.trackID}">
                                </form>
                                <button onclick="document.getElementById('trackViewForm_${loop.index}').submit();"
                                    class="view-artist-btn"
                                    style="background: transparent; border: none; color: #e6f1ff; padding: 0; text-align: left; cursor: pointer; font-size: 16px; font-weight: 600;">
                                    ${item.title}
                                </button>
                                <p class="track-artist">
                                    <c:choose>
                                        <c:when test="${not empty item.artists}">
                                            <c:forEach var="artist" items="${item.artists}" varStatus="artistLoop">
            ...
            <script>
                ...
                function createChart() {
                    // Get track data from the server-side rendered elements
                    const trackItems = document.querySelectorAll('.track-item');
                    const trackData = Array.from(trackItems).map((item, index) => {
                        return {
                            title: item.querySelector('.view-artist-btn').textContent.trim(),
                            plays: parseInt(item.querySelector('.track-plays').textContent),
                    ...
                    if (chartContainer) {
                        ...
                        trackData.forEach((track, index) => {
                            ...
                            tooltipDiv.appendChild(playsElem);
                ...
                // Create chart when page is shown (including when navigating back)
                window.onpageshow = function(event) {
                    // If the page is loaded from cache (when navigating back)
                    if (event.persisted) {
                        createChart();
                    }
                };
            ...
            <div id="deleteAccountModal" class="modal">
                <div class="modal-content">
                    ...
                    <p style="color: #e6f1ff; margin-bottom: 20px;">Are you sure you want to delete your account? This
