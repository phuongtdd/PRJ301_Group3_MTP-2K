    ...
    <%@ page contentType="text/html" pageEncoding="UTF-8" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <title>All Artists - MTP Music</title>
                ...
                <style>
                    ...
                    /* Album grid section styles - Phần lưới hiển thị albums */
                    .artist-section {
                        display: grid;
                    ...
                    /* Album card styles - Style cho thẻ album */
                    .artist-card {
                        background: #112240;
                        padding: 16px;
                        border-radius: 8px;
                ...
                <div class="main-content">
                    ...
                    <div class="artist-section">
                        <c:if test="${not empty artist}">
                            <p>Có ${artist.size()} artists</p>
                        </c:if>
                        <c:if test="${empty artist}">
                            <p>Không có artist nào</p>
                        </c:if>
                        <div class="artist-card">
                            <img src="${pageContext.request.contextPath}/image/sontung.jpg" alt="Artist Cover">
                            <div class="card-info">
                        ...
                        <div class="artist-card">
                            <img src="${pageContext.request.contextPath}/image/jack.jpg" alt="Artist Cover">
                            <div class="card-info">
